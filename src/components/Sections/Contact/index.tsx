...
const Contact: FC = memo(() => {
  ...
  return (
    <Section className="bg-teal-100" sectionId={SectionId.Contact}>
      <div className="flex flex-col gap-y-6">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          ...
          <div className="order-1 col-span-1 flex flex-col gap-y-4 md:order-2">
            <p className="prose leading-6 text-neutral-500">{description}</p>
                    ...
                    <dd className="flex items-center">
                      <a
                        className={classNames(
                          '-m-2 flex rounded-md p-2 text-neutral-500 hover:text-orange-500 focus:outline-none focus:ring-2 focus:ring-orange-500',
